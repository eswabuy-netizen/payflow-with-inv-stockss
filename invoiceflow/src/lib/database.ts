...
import { User, Company, Client, Invoice, Receipt, Quotation, Admin, Expense } from '../types';
      ...
      this.db = await openDB<DatabaseSchema>(DB_NAME, DB_VERSION, {
        upgrade(db) {
          ...
          if (!db.objectStoreNames.contains('expenses')) {
            ...
            expensesStore.createIndex('companyId', 'companyId');
            expensesStore.createIndex('createdBy', 'createdBy');
